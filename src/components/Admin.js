...
//This component will render form to log in admin.
...
//This method validates the incoming admin login data and displays the appropriate error message
    validate = () => {
...
//This method will send the admin login data and authenticate to the backend.
    verifyAdmin = (event) => {
        ...
        return (
            ...
            {/* <div class="container-sm align-self-center"> */}
                <div class="w-50 p-3">
                    ...
                    <form onSubmit={this.verifyAdmin}>
